<div align="center">
  ...
  ![Version](https://img.shields.io/badge/version-8.127.0-blue)
...
```
Nitrite_8.127.0_x64-setup.exe
```

Ou la release portable tout-en-un (`Nitrite_v8.127.0_full.exe`) : app + logiciels portables + drivers + scripts Windows, sans installation.
